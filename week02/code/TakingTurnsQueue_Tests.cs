...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the players were not re-added to the queue after their turn
    ...
    // Defect(s) Found: queue order was incorrect as the players were not re-added correctly
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: players with 0 turns were incorrectly removed from the queue
    ...
    // Defect(s) Found: players with negative turns were also removed incorrectly
